	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<div id="tsfaq" role="tablist" aria-multiselectable="true" class="faq-group">
				...
				<?php if( have_rows('faqs_the_science') ): ?>
					...
					<div class="panel">
						...
						<div class="" role="tab" id="ts-question-<?php echo get_row_index(); ?>">
							<h5 class="">
								<a data-toggle="collapse" data-parent="#tsfaq" href="#ts-answer-<?php echo get_row_index(); ?>" aria-expanded="false" aria-controls="ts-answer-<?php echo get_row_index(); ?>"><?php echo $ts_question; ?>&nbsp;&nbsp;<i class="fa fa-caret-down down" aria-hidden="true"></i></a>
							</h5>
						</div>
						<?php endif; ?>
				...
				<div id="abfaq" role="tablist" aria-multiselectable="true" class="faq-group">
				...
				<?php if( have_rows('faqs_aging_beauty') ): ?>
					...
					<div class="panel">
						...
						<div class="" role="tab" id="ab-question-<?php echo get_row_index(); ?>">
							<h5 class="">
								<a data-toggle="collapse" data-parent="#abfaq" href="#ab-answer-<?php echo get_row_index(); ?>" aria-expanded="false" aria-controls="ab-answer-<?php echo get_row_index(); ?>"><?php echo $ab_question; ?>&nbsp;&nbsp;<i class="fa fa-caret-down down" aria-hidden="true"></i></a>
							</h5>
						</div>
						<?php endif; ?>
				...
				<div id="hmfaq" role="tablist" aria-multiselectable="true" class="faq-group">
				...
				<?php if( have_rows('faqs_healing_medicinal') ): ?>
					...
					<div class="panel">
						...
						<div class="" role="tab" id="hm-question-<?php echo get_row_index(); ?>">
							<h5 class="">
								<a data-toggle="collapse" data-parent="#hmfaq" href="#hm-answer-<?php echo get_row_index(); ?>" aria-expanded="false" aria-controls="hm-answer-<?php echo get_row_index(); ?>"><?php echo $hm_question; ?>&nbsp;&nbsp;<i class="fa fa-caret-down down" aria-hidden="true"></i></a>
							</h5>
						</div>
						<?php endif; ?>
